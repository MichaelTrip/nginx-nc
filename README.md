...
![Build status](https://github.com/MichaelTrip/nginx-nc/actions/workflows/main.yaml/badge.svg)
![GitHub License](https://img.shields.io/github/license/michaeltrip/nginx-nc)
![GitHub last commit](https://img.shields.io/github/last-commit/michaeltrip/nginx-nc?logo=github)
![GitHub tag (with filter)](https://img.shields.io/github/v/tag/michaeltrip/nginx-nc)
